...
export type GetClaimLimitByUserQuery = { __typename?: 'Query', claimLimitsByUser: Array<{ __typename?: 'ClaimLimit', _id: string, year: string, maxAmount: number, balance: number, isActive?: boolean | null, claimType: { __typename?: 'ClaimType', _id: string, name: string, description?: string | null, isActive?: boolean | null }, user: { __typename?: 'User', _id: string, name?: string | null, username: string, email?: string | null, position?: string | null }, approver?: Array<{ __typename?: 'User', _id: string, username: string, email?: string | null, position?: string | null } | null> | null }> };
